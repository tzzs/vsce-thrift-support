// Debug script for enum value selection issue
const fs = require('fs');
...
enum Status {
  ...
  INACTIVE = 2
    ...
    // Test position on "ACTIVE" enum value
    const position = createMockPosition(7, 2); // On "ACTIVE"
    
    console.log('Text content:');
    console.log(text);
    console.log('\nTesting position (7, 2) - should select "ACTIVE"');
    console.log('Line 7 content: "' + text.split('\n')[7] + '"');
    console.log('Character at position (7, 2): "' + text.split('\n')[7][2] + '"');
