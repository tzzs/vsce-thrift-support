...
service UserService {
  shared.Address getUserAddress(1: i32 userId)
    ...
    // Test position on "Address" in function return type
    console.log('\n--- Test 2: Position on "Address" in function return type ---');
    const position2 = createMockPosition(7, 10); // On "Address" in function return type
    ...
    // Test position on "shared" part
    console.log('\n--- Test 3: Position on "shared" part ---');
    const position3 = createMockPosition(4, 15); // On "shared" in field definition
