...
// Patch the ThriftReferencesProvider to add more detailed debugging
const originalFindReferencesInDocument = ThriftReferencesProvider.prototype.findReferencesInDocument;
ThriftReferencesProvider.prototype.findReferencesInDocument = function (uri, text, symbolName) {
    console.log(`\n[DEBUG] findReferencesInDocument called with:`);
    ...
    try {
        return originalFindReferencesInDocument.call(this, uri, text, symbolName);
    } catch (error) {
        console.error(`[ERROR] findReferencesInDocument failed:`, error);
        console.error(`[ERROR] Stack:`, error.stack);
        throw error;
    }
};

async function debugReferencesInDocument() {
    console.log('=== Debugging findReferencesInDocument ===\n');
...
debugReferencesInDocument().catch((error) => {
