...
service UserService {
  shared.Address getUserAddress(1: i32 userId)
    ...
    // Test position on "Address" in field definition (should be line 3, character ~15)
    console.log('\n--- Test 1: Position on "Address" in field definition ---');
    const position1 = createMockPosition(3, 15); // On "Address" in field definition
    ...
    // Test position on "shared" in field definition (should be line 3, character ~10)
    console.log('\n--- Test 2: Position on "shared" in field definition ---');
    const position2 = createMockPosition(3, 10); // On "shared" in field definition
    ...
    // Test position on "Address" in service method (should be line 7, character ~10)
    console.log('\n--- Test 3: Position on "Address" in service method ---');
    const position3 = createMockPosition(7, 10); // On "Address" in service method return type
