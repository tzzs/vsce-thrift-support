...
import {IncrementalParseResult, ThriftParser, nodes} from '@tanzz/thrift-core';
    ...
    public async parseIncrementally(
        ...
        return performanceMonitor.measureAsync('incremental-parser.parseIncrementally', async () => {
            ...
            const result = this.errorHandler.wrapSync(
                () => ThriftParser.incrementalParseWithCache(document.uri.fsPath, document.getText(), range),
                {
