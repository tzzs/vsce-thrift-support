...
exports.formatConstFields = void 0;
function formatConstFields(fields, options, indentLevel, deps) {
    if (fields.length === 0) {
        return [];
    }
...
exports.formatConstFields = formatConstFields;
//# sourceMappingURL=const-format.js.map