 ...
 * 判断位置是否在 range 内。
 */
export function positionInRange(range: Range, position: Position): boolean {
 ...
 * 查找包含指定位置的最小节点。
 */
export function findSmallestNodeAtPosition(doc: nodes.ThriftDocument, position: Position): nodes.ThriftNode | undefined {
